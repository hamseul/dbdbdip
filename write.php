<?php
 ...
 ?>
 <?php
 	$product_num = $_REQUEST['idx'];
 	$query= "SELECT * FROM wow_subtable WHERE no='$product_num'";  //desc 내림차순   ASC 오름차순
...
<tr>
    <td width='100%' height='30' colspan='2' bgcolor='FFFFF' align='center'> <?php echo "<b>".$data['product_name']."</b>에 대한 정보를 추가합니다." ?> </td>


<form name='write' action='write_post.php?idx=<?=$product_num?>' method='post' enctype='multipart/form-data'>
<tr>
...
<td width='100%' height='420'  align='center' valign='middle' colspan='2'>
 <textarea id='ir1' name='story' style="width:886px; height:400px;"></textarea>
</td>
